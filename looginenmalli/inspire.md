...
| geometry: GM_MultiSurface [1]    | Kaavakohde.geometria                           | geometria on aina aluemainen, ks. Soveltamisohjeet [asemakaava, vaatimus ```vaat-aluemainen-kayttotarkoitusalue```](/kaavatiedot/soveltamisprofiili/asemakaava/v1.0/laatusaannot.html#sov-ak-vaat-aluemainen-kayttotarkoitusalue) ja [yleiskaava, vaatimus ```vaat-aluemainen-aluevaraus```](/kaavatiedot/soveltamisprofiili/soveltamisohjeet/yleiskaava/v1.0/laatusaannot.html#sov-yk-vaat-aluemainen-aluevaraus)
